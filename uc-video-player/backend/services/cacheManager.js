...
const CACHE_DIR = path.resolve('C:/Users/prave/.gemini/antigravity-ide/scratch/uc-video-player/cache');
...
export function registerDownloadName(hash, filename) {
 ...
 */
export function getCachedRangeOffset(task, start, end) {
 ...
 */
export function getCacheStatus(videoUrl) {
  const urlHash = getUrlHash(videoUrl);
