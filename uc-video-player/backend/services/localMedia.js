...
/**
 * Returns standard directories to scan for local media files
 */
export function getScanDirectories() {
 ...
 */
export function scanLocalVideos(dirPath, depth = 0, maxDepth = 2) {
  let results = [];
